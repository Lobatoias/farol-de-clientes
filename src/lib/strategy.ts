...
export const ACTION_CHECKLISTS: Record<string, string[]> = {
  "critical-account": [
    "Listar TODAS as reclamações dos últimos 30 dias (tickets, mensagens, atas de reunião)",
    "Identificar a reclamação principal — a dor real do cliente, não o sintoma",
    "Mapear o gap operacional: o que deveria estar entregue e não está (criativo, segmentação, frequência, mensuração)",
    "Definir 2-3 otimizações concretas com prazo e responsável (ex: trocar criativo até sexta, ajustar segmentação até quarta)",
    "Marcar reunião com o cliente pra apresentar o diagnóstico + plano de otimização (não pedir paciência sem plano)",
    "Definir métricas de validação semanais e cadência de update pro cliente",
    "Escalar pra Head e atribuir owner único do caso até estabilizar",
  ],
  "niche-concentration": [
    "Reunir CSMs com clientes desse nicho pra mapear reclamações comuns",
    "Identificar padrões operacionais que falham: briefing genérico, criativo, frequência, plataforma errada",
    "Criar playbook específico do nicho com etapas obrigatórias e critérios de qualidade",
    "Definir métricas de saúde do nicho (CTR, CPL, ROAS) com benchmark de referência",
    "Treinar todos os CSMs do nicho no playbook em até 2 semanas",
    "Aplicar otimizações nos clientes ativos em ondas, priorizando os vermelhos/amarelos",
  ],
  "csm-load": [
    "Conversar 1-1 com o CSM pra entender se é volume ou skill específica",
    "Avaliar redistribuição da carteira (passar 1-2 clientes pra outro CSM com folga)",
    "Verificar gap de habilidade no CSM (ferramenta, vertical, comunicação com cliente)",
    "Definir buddy/mentor pra apoiar nos próximos 30 dias",
    "Treinar especificamente no nicho que está concentrando críticos na carteira",
    "Padronizar cadência de check-in do Head com o CSM (semanal nas primeiras 4 semanas)",
  ],
  "contract-expiring": [
    "Levantar resultados reais entregues nos últimos 90 dias (número, não percepção)",
    "Listar reclamações registradas no período e o que foi feito a respeito",
    "Identificar 3-5 otimizações concretas pro próximo ciclo, baseadas nas reclamações",
    "Preparar relatório executivo: resultados + diagnóstico + plano de otimização",
    "Agendar reunião de renovação com 2-3 semanas de antecedência (não em cima da hora)",
    "Conduzir a conversa com base em valor entregue + otimizações futuras (manutenção do valor, não preço)",
  ],
  "missing-niche": [
